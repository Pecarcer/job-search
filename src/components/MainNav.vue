      ...
      <div class="flex flex-nowrap h-full border-b border-solid border-brand-gray-1 px-8 mx-auto">
        ...
        <nav class="ml-12 h-full">
          <ul class="flex h-full list-none">
            <li v-for="menuItem in menuItems" v-bind:key="menuItem" class="ml-9 h-full first:ml-0">
...
export default {
  ...
  data() {
    return {
      company: 'Mochi Careers',
      url: 'https://careers.google.com',
      menuItems: ['Teams', 'Locations', 'Life at Mochi Careers', 'How we hire', 'Students', 'Jobs']
    }
  }
}
</script>
